...
from .views import tambah_produk, upload_paket_soal, detail_produk, edit_produk, paket_soal_detail, hapus_soal, edit_soal, tambah_soal
...
urlpatterns = [
    ...
    path('paket-soal/<uuid:uuid>/tambah-soal/', tambah_soal, name='tambah_soal'),
